...
Rattlesnake is a game built with JavaScript/jQuery based on the classic arcade game Snake. The goal is to direct the snake toward the white squares (eggs). Ten points are awarded for each egg eaten. (live: http://dgskinner.github.io)
